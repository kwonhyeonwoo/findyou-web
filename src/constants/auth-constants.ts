...
// 2. 외부에서 인자들을 받아와서 배열을 리턴하는 함수형 상수로 선언
...
export const getBasicInputs = ({
  ...
  },
  {
    ...
    type: "text",
    activeText: "인증 받기",
    onActive: onPhoneVerifyRequest, // 💡 외부에서 주입받은 함수 매칭
  },
  {
    name: "division", // 인증번호 입력칸 스키마 명칭에 맞게 매칭 (예시)
    label: "인증번호",
    placeholder: "인증번호 입력",
    type: "text",
    activeText: "인증하기",
    onActive: onPhoneVerifyConfirm, // 💡 외부에서 주입받은 함수 매칭
  },
];
